...
- [02-線上評估：A-B-回饋閉環-人工標註流程](06-評估與觀測（讓工程團隊能迭代）/02-線上評估：A-B-回饋閉環-人工標註流程.md)
...
- [01-導入路線圖（PoC→試點→正式）](09-導入既有場景（工程團隊落地配方）/01-導入路線圖（PoC→試點→正式）.md)
- [02-文件型知識庫配方（企業內規-手冊-規格）](09-導入既有場景（工程團隊落地配方）/02-文件型知識庫配方（企業內規-手冊-規格）.md)
- [03-研發型知識庫配方（issues-PRD-設計文-ADR）](09-導入既有場景（工程團隊落地配方）/03-研發型知識庫配方（issues-PRD-設計文-ADR）.md)

### 10-附錄

- [01-Checklist（上線前-事故後）](10-附錄/01-Checklist（上線前-事故後）.md)
- [02-FAQ（常見誤解與坑）](10-附錄/02-FAQ（常見誤解與坑）.md)
- [03-參考文獻與延伸閱讀](10-附錄/03-參考文獻與延伸閱讀.md)

## 範例專案

在 `examples/django-rag-service/` 會提供最小可落地骨架（Postgres+pgvector、ingest/index、檢索 API、LLM 抽象介面）。
